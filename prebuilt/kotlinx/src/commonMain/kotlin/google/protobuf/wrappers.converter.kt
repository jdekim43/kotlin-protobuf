...
public fun DoubleValue.toAny(): Any = Any(DoubleValue.TYPE_URL, with(DoubleValueConverter) { toByteArray() })

public fun Any.parse(converter: ProtobufConverter<DoubleValue> = DoubleValueConverter): DoubleValue {
...
public fun FloatValue.toAny(): Any = Any(FloatValue.TYPE_URL, with(FloatValueConverter) { toByteArray() })
...
public fun Int64Value.toAny(): Any = Any(Int64Value.TYPE_URL, with(Int64ValueConverter) { toByteArray() })
...
public fun UInt64Value.toAny(): Any = Any(UInt64Value.TYPE_URL, with(UInt64ValueConverter) { toByteArray() })

public fun Any.parse(converter: ProtobufConverter<UInt64Value> = UInt64ValueConverter): UInt64Value {
...
public fun Int32Value.toAny(): Any = Any(Int32Value.TYPE_URL, with(Int32ValueConverter) { toByteArray() })
...
public fun UInt32Value.toAny(): Any = Any(UInt32Value.TYPE_URL, with(UInt32ValueConverter) { toByteArray() })

public fun Any.parse(converter: ProtobufConverter<UInt32Value> = UInt32ValueConverter): UInt32Value {
...
public fun StringValue.toAny(): Any = Any(StringValue.TYPE_URL, with(StringValueConverter) { toByteArray() })

public fun Any.parse(converter: ProtobufConverter<StringValue> = StringValueConverter): StringValue {
...
public fun BytesValue.toAny(): Any = Any(BytesValue.TYPE_URL, with(BytesValueConverter) { toByteArray() })
