...
public open class FileOptionsJvmConverter :
  ...
  override fun convert(obj: FileOptions): DescriptorProtos.FileOptions {
    ...
    val value10 = obj.deprecated
    if (value10 != null) {
      builder.setDeprecated(value10)
    }
    val value11 = obj.ccEnableArenas
    if (value11 != null) {
      builder.setCcEnableArenas(value11)
    }
    val value12 = obj.objcClassPrefix
    if (value12 != null) {
      builder.setObjcClassPrefix(value12)
    }
    val value13 = obj.csharpNamespace
    if (value13 != null) {
      builder.setCsharpNamespace(value13)
    }
    val value14 = obj.swiftPrefix
    if (value14 != null) {
      builder.setSwiftPrefix(value14)
    }
    val value15 = obj.phpClassPrefix
    if (value15 != null) {
      builder.setPhpClassPrefix(value15)
    }
    val value16 = obj.phpNamespace
    if (value16 != null) {
      builder.setPhpNamespace(value16)
    }
    val value17 = obj.phpMetadataNamespace
    if (value17 != null) {
      builder.setPhpMetadataNamespace(value17)
    }
    val value18 = obj.rubyPackage
    if (value18 != null) {
      builder.setRubyPackage(value18)
    }
    val value19 = obj.features
    if (value19 != null) {
      builder.setFeatures(FeatureSetConverter.convert(value19))
    }
    builder.addAllUninterpretedOption(obj.uninterpretedOption.map {
        UninterpretedOptionConverter.convert(it) })
    return builder.build()
...
public open class FieldOptionsJvmConverter :
  ...
  override fun convert(obj: FieldOptions): DescriptorProtos.FieldOptions {
    ...
    val value12 = obj.featureSupport
    if (value12 != null) {
      builder.setFeatureSupport(FieldOptionsConverter.FeatureSupportConverter.convert(value12))
    }
    builder.addAllUninterpretedOption(obj.uninterpretedOption.map {
        UninterpretedOptionConverter.convert(it) })
    return builder.build()
  ...
  public open class FeatureSupportJvmConverter :
    ...
    override fun convert(obj: FieldOptions.FeatureSupport):
      ...
      val value0 = obj.editionIntroduced
      if (value0 != null) {
        builder.setEditionIntroduced(DescriptorProtos.Edition.forNumber(value0.number))
      }
      val value1 = obj.editionDeprecated
      if (value1 != null) {
        builder.setEditionDeprecated(DescriptorProtos.Edition.forNumber(value1.number))
      }
      val value2 = obj.deprecationWarning
      if (value2 != null) {
        builder.setDeprecationWarning(value2)
      }
      val value3 = obj.editionRemoved
      if (value3 != null) {
        builder.setEditionRemoved(DescriptorProtos.Edition.forNumber(value3.number))
      }
      return builder.build()
    }
  }
...
public open class FeatureSetDefaultsJvmConverter :
  ...
  public open class FeatureSetEditionDefaultJvmConverter :
    ...
    override fun convert(obj: FeatureSetDefaults.FeatureSetEditionDefault):
      ...
      val value1 = obj.overridableFeatures
      if (value1 != null) {
        builder.setOverridableFeatures(FeatureSetConverter.convert(value1))
      }
      val value2 = obj.fixedFeatures
      if (value2 != null) {
        builder.setFixedFeatures(FeatureSetConverter.convert(value2))
      }
      return builder.build()
    }
  }
