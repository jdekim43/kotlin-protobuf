...
object OneOfTypePlugin : TypeGenerator.Plugin<Descriptors.OneofDescriptor> {
    ...
    override fun applyTo(spec: TypeSpec.Builder, imports: MutableSet<Import>, descriptor: Descriptors.OneofDescriptor) {
...
object OneOfItemTypePlugin : TypeGenerator.Plugin<Descriptors.FieldDescriptor> {
    ...
    override fun applyTo(spec: TypeSpec.Builder, imports: MutableSet<Import>, descriptor: Descriptors.FieldDescriptor) {
